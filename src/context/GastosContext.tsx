...
const GASTOS_DEFAULT: Gastos = [
  { id: 'combustible', label: 'Combustible', desc: '100km/día x 26 días', value: '515' },
  { id: 'mantenimiento', label: 'Mantenimiento', desc: 'Cambio de aceite y ajustes', value: '120' },
  { id: 'repuestos', label: 'Fondo de Repuestos', desc: 'Frenos, llantas, etc.', value: '150' },
  { id: 'alimentacion', label: 'Alimentación', desc: 'Menú diario (S/ 12 x 26 días)', value: '312' },
  { id: 'estacionamiento', label: 'Estacionamiento', desc: 'Pago mensual fijo', value: '270' },
  { id: 'planDatos', label: 'Plan de Datos', desc: 'Recarga/Recibo mensual', value: '40' },
